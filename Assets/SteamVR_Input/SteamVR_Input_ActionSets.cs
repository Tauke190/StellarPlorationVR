...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_VR_Input_actions p_VR_Input_actions;
        ...
        public static SteamVR_Input_ActionSet_VR_Input_actions VR_Input_actions
        {
            get
            {
                return SteamVR_Actions.p_VR_Input_actions.GetCopy<SteamVR_Input_ActionSet_VR_Input_actions>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_VR_Input_actions = ((SteamVR_Input_ActionSet_VR_Input_actions)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_VR_Input_actions>("/actions/VR_Input_actions")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.VR_Input_actions};
        }
    }
}
